...
public class IfThenElseTest {
    ...
    @Test
    public void CheckSemantics_ShouldPass_BalanceDeletion() throws BehaviourError {
    ...
    @Test
    public void CheckSemantics_ShouldFail_WithUseAfterDeletion() throws BehaviourError {
        List<SemanticError> errors = checkSemantics("{" +
                "int x = 1;" +
                "if (x) then {delete x;}" +
                "else { delete x;}" +
        ...
        assertEquals("x", ((UnboundSymbolError) errors.get(0)).getId());
    }
}
