...
public class Registers {
    ...
    public static final Map<String, Function<LvmVisitorImpl, Integer>> GET_REGISTER_VALUE;
    public static final Map<String, BiFunction<LvmVisitorImpl, Integer, Integer>> SET_REGISTER_VALUE;
